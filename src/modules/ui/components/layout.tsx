        ...
        <div class="modal-card" style="width: 800px; max-width: 90vw;">
          ...
          <section class="modal-card-body">
            <div class="notification is-warning is-light">
              The following SQL statements will be executed against the database. Please review them
              carefully.
            </div>
            <div class="control">
              <textarea
                id="sql-preview-content"
          ...
          <footer class="modal-card-foot">
            <button id="sql-confirm-btn" class="button is-danger">
              Execute SQL
            </button>
                  ...
                  <button class="button" onclick="toggleDropdown('project-dropdown')">
                    <span>
                      {props.currentProjectId
                        ? props.projects.find((p) => p.id === props.currentProjectId)?.name ||
                          'Select Project'
                        : 'Select Project'}
                    </span>
      ...
      <div class="columns is-gapless mb-0" style="min-height: calc(100vh - 3.25rem);">
        ...
        {props.currentProjectId && (
          <div
            ...
            style="width: 70px; background-color: #1a1b1e; border-right: 1px solid #2c2d30; display: flex; flex-direction: column; align-items: center; padding-top: 20px; flex-shrink: 0;"
          >
            {/* Overview */}
            <a
              href={`/ui/projects/${props.currentProjectId}`}
            ...
            {/* Database */}
            <a
              href={`/ui/projects/${props.currentProjectId}?tab=database`}
              class="has-tooltip-right"
        ...
        <div
          class="column is-2 has-background-white-bis"
          style="border-right: 1px solid #dbdbdb; min-width: 220px; max-width: 260px;"
        >
          <aside class="menu section py-5 px-4">
            ...
            {props.currentProjectId && (!props.activeTab || props.activeTab === 'overview') && (
              <>
                ...
                <ul class="menu-list">
                  ...
                  <li>
                    <a href={`/ui/projects/${props.currentProjectId}/settings`}>Settings</a>
                  </li>
                </ul>
              </>
            )}
                    ...
                    <div class="field">
                      ...
                      <div class="control">
                        <div class="select is-fullwidth is-small">
                          <select
                            onchange={`window.location.href='/ui/projects/${props.currentProjectId}?db=' + this.value + '&tab=database'`}
                          >
                            {props.databases.map((db: any) => (
                              <option
                                value={db.name}
                                selected={db.name === props.currentDatabaseName}
                              >
                                {db.name}
                              </option>
                            ))}
                      ...
                      {props.collections?.map((col: any) => (
                        <li>
                          <a
                            ...
                            class={
                              props.children?.props?.children?.[0]?.props?.children?.[2]?.props
                                ?.children === col.name
                                ? 'is-active'
                                : ''
                            }
            ...
            {props.currentProjectId && props.activeTab === 'files' && (
              <>
                ...
                <ul class="menu-list">
                  <li>
                    <a class="is-disabled">Coming soon...</a>
                  </li>
                </ul>
              </>
            )}
            ...
            {!props.currentProjectId && (
              <ul class="menu-list">
                <li>
                  <a href="/ui/projects" class={props.active === 'projects' ? 'is-active' : ''}>
                    Projects
                  </a>
                </li>
              </ul>
