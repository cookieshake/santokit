  ...
  <Layout title="Projects" active="projects" account={props.account} projects={props.projects}>
      ...
      <div class="modal-card">
        ...
        <footer class="modal-card-foot">
          <button
            ...
            onclick="document.getElementById('new-project-form').requestSubmit()"
          >
            Create
          </button>
          <button class="button" onclick="hideModal('new-project-modal')">
            Cancel
          </button>
        </footer>
      </div>
          ...
          <tbody>
            {props.projects.map((p) => (
              <tr>
                ...
                <td>{p.name}</td>
                <td>
                  <a href={`/ui/projects/${p.id}`} class="button is-small">
                    Manage
                  </a>
                  {p.name !== 'system' && (
                    <button
                      class="button is-small is-danger ml-2"
                      onclick={`showDeleteModal('${p.id}', '${p.name}')`}
                    >
                      Delete
                    </button>
                  )}
    ...
    <div id="delete-project-modal" class="modal">
      ...
      <div class="modal-card">
        ...
        <section class="modal-card-body">
          <p>
            Are you sure you want to delete project <strong id="delete-project-name"></strong>?
          </p>
          <br />
          <div class="field">
            <div class="control">
            ...
            <p class="help is-danger">
              Warning: checking this will permanently delete all data tables for this project.
            </p>
          </div>
        ...
        <footer class="modal-card-foot">
          <button class="button is-danger" onclick="confirmDeleteProject()">
            Delete
          </button>
          <button class="button" onclick="hideModal('delete-project-modal')">
            Cancel
          </button>
        </footer>
      </div>
