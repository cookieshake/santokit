...
if (isProduction) {
  ...
  if (!process.env.PASETO_KEY) throw new Error('PASETO_KEY is required in production')
...
export const config = {
  ...
  auth: {
    pasetoKey:
      process.env.PASETO_KEY || '707172737475767778797a7b7c7d7e7f808182838485868788898a8b8c8d8e8f',
    initialAdmin: {
